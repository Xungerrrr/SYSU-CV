...
/* The constructor. */
Hough::Hough(char *in, CImg<unsigned char> edge_image, int threshold, int r) {
...
/* Start the line detection process. */
void Hough::line_detection() {
	if(VERBOSE) cout << "Starting line detection." << endl;
...
void Hough::output() {
	...
	if(VERBOSE) cout << "Writing the line image in the file " 
					 << outfilename << "." << endl;
